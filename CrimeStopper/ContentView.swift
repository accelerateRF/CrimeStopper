...
let staticCrimeData = [ CrimeData(id: 0,
                  ...
                  CrimeData(id: 2,
                            ...
                            messages: [Message(time: "145p", name: "Chan L", language: "Cantonese", phone: "408.332.1112", description: "Saw a couple of guys break into a white car. They parked next to it and immediately smashed the window."),
                                                         Message(time: "150p", name: "Terry B", phone: "415.123.6688", description: "A car parked in front of the Ikon Hotel got broken into and the some of the luggage was dropped on the sidewalk. I packed it up and left it with the hotel front desk."),
                                                        ]),
                  CrimeData(id: 3,
                                              title: "Theft",
